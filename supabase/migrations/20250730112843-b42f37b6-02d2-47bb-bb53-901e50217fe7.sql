...
-- Corriger les types ENUM de la table maintenance pour accepter plus de valeurs
DROP TYPE IF EXISTS type_panne_enum CASCADE;
CREATE TYPE type_panne_enum AS ENUM (
  'plomberie', 
  'electricite', 
  'chauffage', 
  'climatisation', 
...
-- Mettre à jour la table maintenance avec le nouveau type
ALTER TABLE public.maintenance ALTER COLUMN type_panne TYPE type_panne_enum USING type_panne::text::type_panne_enum;
